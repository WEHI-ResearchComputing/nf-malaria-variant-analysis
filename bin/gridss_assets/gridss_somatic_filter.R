...
befiltered = gridss_breakend_filter(begr, full_vcf, normalOrdinal=argv$normalordinal, tumourOrdinal=argv$tumourordinal)
...
bpfiltered = gridss_breakpoint_filter(bpgr, full_vcf, bsgenome=refgenome, normalOrdinal=argv$normalordinal, tumourOrdinal=argv$tumourordinal)
# pon_dir=argv$pondir, removed
