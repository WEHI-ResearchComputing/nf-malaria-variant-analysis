...
AccumulateQualityYieldMetrics () { 
    picard AccumulateQualityYieldMetrics "$@" 
}
AccumulateVariantCallingMetrics () { 
    picard AccumulateVariantCallingMetrics "$@" 
}
AddCommentsToBam () { 
...
CalculateFingerprintMetrics () { 
    picard CalculateFingerprintMetrics "$@" 
}
CalculateReadGroupChecksum () { 
    picard CalculateReadGroupChecksum "$@" 
}
CheckDuplicateMarking () { 
    picard CheckDuplicateMarking "$@" 
}
CheckFingerprint () { 
...
CollectArraysVariantCallingMetrics () { 
    picard CollectArraysVariantCallingMetrics "$@" 
}
...
CollectIndependentReplicateMetrics () { 
    picard CollectIndependentReplicateMetrics "$@" 
}
...
CombineGenotypingArrayVcfs () { 
    picard CombineGenotypingArrayVcfs "$@" 
}
CompareGtcFiles () { 
    picard CompareGtcFiles "$@" 
}
CompareMetrics () { 
...
SimpleMarkDuplicatesWithMateCigar () { 
    picard SimpleMarkDuplicatesWithMateCigar "$@" 
}
SortGff () { 
    picard SortGff "$@" 
}
